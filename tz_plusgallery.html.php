                            ...
                            <div id="accordion">
                                ...
                                <div>
                                    ...
                                    <select name="options_layout" class="options_layout">
                                        <option value="http://wordpress.templaza.net/plugins/tzplusgallery/default-layout/" selected> Default</option>
                                        <option value="http://wordpress.templaza.net/plugins/tzplusgallery/mirror-grid/">Mirror</option>
                                        <option value="http://wordpress.templaza.net/plugins/tzplusgallery/zumion-grid/">Zumion</option>
                                        <option value="http://wordpress.templaza.net/plugins/tzplusgallery/rolly-grid/">Rolly</option>
                                        <option value="http://wordpress.templaza.net/plugins/tzplusgallery/ming-conner-masonry/">Ming Corner</option>
                                        <option value="http://wordpress.templaza.net/plugins/tzplusgallery/nice-lily-grid/">Nice Lily</option>
                                        <option value="http://wordpress.templaza.net/plugins/tzplusgallery/folio-grid-flickr/">Folio</option>
                                        <option value="http://wordpress.templaza.net/plugins/tzplusgallery/everline-grid-facebook/">Everline</option>
                                        <option value="http://wordpress.templaza.net/plugins/tzplusgallery/lania-grid/">Lania</option>
                                        <option value="http://wordpress.templaza.net/plugins/tzplusgallery/swift-grid/">Swift</option>
                                        <option value="http://wordpress.templaza.net/plugins/tzplusgallery/aragon-grid/">Aragon</option>
                                        <option value="http://wordpress.templaza.net/plugins/tzplusgallery/elegant-grid/">Elegant</option>
                                        <option value="http://wordpress.templaza.net/plugins/tzplusgallery/pinme-grid/">Pinme</option>
                                        <option value="http://wordpress.templaza.net/plugins/tzplusgallery/simple-grid/">Simple</option>
                                        <option value="http://wordpress.templaza.net/plugins/tzplusgallery/black-white/">Black & White</option>
                                        <option value="http://wordpress.templaza.net/plugins/tzplusgallery/coffee-grid-flickr/">Coffee</option>
                                    </select>
