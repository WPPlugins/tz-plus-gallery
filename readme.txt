...
Tags: plugins, social plugin, gallery,wordpress albums, social gallery, facebook album, google album, instagram album, flickr album.
...
TZ Plus Gallery display all your albums from social source Facebook, Flickr, Instagram, Google+ and WordPress on your site.
...
<br>
[Pro Version](http://wordpress.templaza.net/plugins/tzplusgallery/ "Pro Version")
...
= 1.5.2 =
* Fixed duplicate post description.
...
* Fixed Flickr Data API Key.


= 1.1.3 =
* Fixed limit albums display only 16 albums.
...
= 1.1.0 =
* Update quality thumbnail image for free version.
* Pro version supported 14 awesome layouts.
