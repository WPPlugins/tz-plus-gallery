                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-6 col-xs-12 gallery_item">
                                    <div class="item item_mirror">
                                        <a target="_blank" href="http://wordpress.templaza.net/plugins/tzplusgallery/zumion-grid/" class="view_more">
                                            <img alt="Mirror" src="http://wordpress.templaza.net/plugins/tzplusgallery/wp-content/themes/tz_extension/images/mirror.jpg">
                                        </a>
                                        <h3>Mirror Layout</h3>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12 gallery_item">
                                    <div class="item item_zumi">
                                        <a target="_blank" href="http://wordpress.templaza.net/plugins/tzplusgallery/zumion-masonry/" class="view_more">
                                            <img alt="Zumi" src="http://wordpress.templaza.net/plugins/tzplusgallery/wp-content/themes/tz_extension/images/zumi.jpg">
                                        </a>
                                        <h3>Zumion Layout</h3>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12 gallery_item">
                                    <div class="item item_rolly">
                                        <a target="_blank" href="http://wordpress.templaza.net/plugins/tzplusgallery/rolly-grid/" class="view_more">
                                            <img alt="Rolly" src="http://wordpress.templaza.net/plugins/tzplusgallery/wp-content/themes/tz_extension/images/rolly.jpg">
                                        </a>
                                        <h3>Rolly Layout</h3>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12 gallery_item">
                                    <div class="item item_ming">
                                        <a target="_blank" href="http://wordpress.templaza.net/plugins/tzplusgallery/ming-conner-grid/" class="view_more">
                                            <img alt="Ming" src="http://wordpress.templaza.net/plugins/tzplusgallery/wp-content/themes/tz_extension/images/ming.jpg">
                                        </a>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12 gallery_item">
                                    <div class="item item_lily">
                                        <a target="_blank" href="http://wordpress.templaza.net/plugins/tzplusgallery/nice-lily-masonry/" class="view_more">
                                            <img alt="Lily" src="http://wordpress.templaza.net/plugins/tzplusgallery/wp-content/themes/tz_extension/images/lily.jpg">
                                        </a>
                                        <h3>Lily Layout</h3>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12 gallery_item">
                                    <div class="item item_masonry">
                                        <a target="_blank" href="http://wordpress.templaza.net/plugins/tzplusgallery/folio-grid-flickr/" class="view_more">
                                            <img alt="Folio" src="http://wordpress.templaza.net/plugins/tzplusgallery/wp-content/themes/tz_extension/images/folio.jpg">
                                        </a>
                                        <h3>Folio Layout</h3>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12 gallery_item">
                                    <div class="item item_masonry">
                                        <a target="_blank" href="http://wordpress.templaza.net/plugins/tzplusgallery/everline-grid-facebook/" class="view_more">
                                            <img alt="Everline" src="http://wordpress.templaza.net/plugins/tzplusgallery/wp-content/themes/tz_extension/images/everline.jpg">
                                        </a>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12 gallery_item">
                                    <div class="item item_masonry">
                                        <a target="_blank" href="http://wordpress.templaza.net/plugins/tzplusgallery/lania-masonry-facebook/" class="view_more">
                                            <img alt="Lania" src="http://wordpress.templaza.net/plugins/tzplusgallery/wp-content/themes/tz_extension/images/lania.jpg">
                                        </a>
                                        <h3>Lania Layout</h3>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12 gallery_item">
                                    <div class="item item_masonry">
                                        <a target="_blank" href="http://wordpress.templaza.net/plugins/tzplusgallery/swift-masonry-facebook/" class="view_more">
                                            <img alt="Swift" src="http://wordpress.templaza.net/plugins/tzplusgallery/wp-content/themes/tz_extension/images/swift.jpg">
                                        </a>
                                        <h3>Swift Layout</h3>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12 gallery_item">
                                    <div class="item item_masonry">
                                        <a target="_blank" href="http://wordpress.templaza.net/plugins/tzplusgallery/aragon-masonry-facebook/" class="view_more">
                                            <img alt="Aragon" src="http://wordpress.templaza.net/plugins/tzplusgallery/wp-content/themes/tz_extension/images/aragon.jpg">
                                        </a>
                                        <h3>Aragon Layout</h3>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12 gallery_item">
                                    <div class="item item_masonry">
                                        <a target="_blank" href="http://wordpress.templaza.net/plugins/tzplusgallery/elegant-grid/" class="view_more">
                                            <img alt="Elegant" src="http://wordpress.templaza.net/plugins/tzplusgallery/wp-content/themes/tz_extension/images/elegant.jpg">
                                        </a>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12 gallery_item">
                                    <div class="item item_masonry">
                                        <a target="_blank" href="http://wordpress.templaza.net/plugins/tzplusgallery/pinme-masonry-facebook/" class="view_more">
                                            <img alt="Pinme" src="http://wordpress.templaza.net/plugins/tzplusgallery/wp-content/themes/tz_extension/images/pinme.jpg">
                                        </a>
                                        <h3>Pinme Layout</h3>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12 gallery_item">
                                    <div class="item item_masonry">
                                        <a target="_blank" href="http://wordpress.templaza.net/plugins/tzplusgallery/simple-grid/" class="view_more">
                                            <img alt="Simple" src="http://wordpress.templaza.net/plugins/tzplusgallery/wp-content/themes/tz_extension/images/simple.jpg">
                                        </a>
                                        <h3>Simple Layout</h3>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12 gallery_item">
                                    <div class="item item_masonry">
                                        <a target="_blank" href="http://wordpress.templaza.net/plugins/tzplusgallery/black-white/" class="view_more">
                                            <img alt="Black &amp; White" src="http://wordpress.templaza.net/plugins/tzplusgallery/wp-content/themes/tz_extension/images/black.jpg">
                                        </a>
